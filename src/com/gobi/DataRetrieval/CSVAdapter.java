             ...
             //InputStream is = ctx.getAssets().open("states.csv"); 
                ...
                while ((line = reader.readLine()) != null) {
                	Log.i("loadArrayFromFile", "while LOOP");
                    	...
                    	Log.i("Post_ID", RowData[0]);
                    	Log.i("Mid_Block_ID", RowData[1]);
                        Log.i("Street_1", RowData[2]);
                     	Log.i("Street_2", RowData[3]);
                    	Log.i("Street_3", RowData[4]);
                    	Log.i("Side", RowData[5]);
                    	Log.i("Latitude", RowData[6]);
                    	Log.i("Longitude", RowData[7]);
                    	Log.i("Core", RowData[8]);
                    	Log.i("Notes", RowData[9]);
                        ...
                        cur.setPost_ID((RowData[0]));
                        cur.setMid_Block_ID((RowData[1]));
                        cur.setStreet_1((RowData[2]));
                        cur.setStreet_2((RowData[3]));
                        cur.setStreet_3((RowData[4]));
                        cur.setSide((RowData[5]));
                        cur.setLatitude((RowData[6]));
                        cur.setLongitude((RowData[7]));
                        cur.setCore((RowData[8]));
                        cur.setNotes((RowData[9]));
